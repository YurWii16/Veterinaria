...
*   HighlightUpcomingDirective (highlight-upcoming.ts): Añade dinamicamente la clase de resplandor upcoming-highlight a las tarjetas en el DOM si la cita ocurre dentro de las proximas 24 horas.
